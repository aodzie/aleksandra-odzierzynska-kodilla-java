...
public class CrudAppTestSuite{
    private static final String BASE_URL = "https://aodzie.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("twoj_login");   //login to change
        driverTrello.findElement(By.id("password")).sendKeys("twoje_haslo"); //password to change
